package com.mappls.app.navigation.demo.model;
...
import com.mappls.app.navigation.demo.utils.Validator;
...
public class Stop implements Parcelable {
    ...
    public void setELocation(double eLatitude, double eLongitude) {
        mEntryLocation = new Location("EMappls");
